from .seriaizers import UserRegiSerializer
...
from japp.api.seriaizers import LoginSerializer,LogoutSerializer
...
@swagger_auto_schema(method="post",request_body=UserRegiSerializer())
@api_view(['POST'])
